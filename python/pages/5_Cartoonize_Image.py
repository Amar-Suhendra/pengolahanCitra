...
def cartoonize_image(image_path):
    ...
    edge_threshold = 100
    edges = cv2.Canny(grayscale_image, threshold1=edge_threshold, threshold2=2 * edge_threshold)
...
def main():
    ...
    if uploaded_image:
        ...
        if st.button("Cartoonize"):
            ...
            st.image(cartoonized, caption="Cartoonized Image", use_column_width=True)
